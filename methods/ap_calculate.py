...
# 参考https://medium.com/@timothycarlen/understanding-the-map-evaluation-metric-for-object-detection-a07fe6962cf3
# github地址 https://gist.github.com/tarlen5/008809c3decf19313de216b9208f3734
...
def get_avg_precision_at_iou(gt_boxes, pred_boxes, iou_thr=0.5):
    ...
    ### 类似如下的这种映射关系
    # {0.9977: ['img_00401.png', 'img_00217.png', 'img_00165.png', 'img_00185.png', 'img_00185.png', 'img_00125.png',
    ...
    ### pred_boxes是针对每张图片中的pred_boxes的scores进行排序的输出～
...
if __name__ == "__main__":
    ...
    with open('../data/ground_truth_boxes.json') as infile:
        gt_boxes = json.load(infile)

    with open('../data/predicted_boxes.json') as infile:
